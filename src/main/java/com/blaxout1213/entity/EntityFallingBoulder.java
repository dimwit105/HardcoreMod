...
public class EntityFallingBoulder extends EntityFallingBlock
{
    ...
    public EntityFallingBoulder(World p_i1706_1_)
    {
        super(p_i1706_1_);
    ...
    public EntityFallingBoulder(World p_i45318_1_, double p_i45318_2_, double p_i45318_4_, double p_i45318_6_, Block p_i45318_8_)
    {
        this(p_i45318_1_, p_i45318_2_, p_i45318_4_, p_i45318_6_, p_i45318_8_, 0);
    }

    public EntityFallingBoulder(World p_i45319_1_, double p_i45319_2_, double p_i45319_4_, double p_i45319_6_, Block p_i45319_8_, int p_i45319_9_)
    {
        super(p_i45319_1_);
        this.field_145813_c = true;
        this.field_145815_h = 40;
                ...
                if (this.onGround)
                {
                    ...
                    if (this.worldObj.getBlock(i, j, k) != Blocks.piston_extension)
                    {
                        ...
                        else if (this.field_145813_c && !this.field_145808_f)
                        {
                            ...
                            EntityBoulderSpider entitysilverfish = new EntityBoulderSpider(worldObj);
                            entitysilverfish.setLocationAndAngles((double)this.posX, (double)this.posY, (double)this.posZ, 0.0F, 0.0F);
