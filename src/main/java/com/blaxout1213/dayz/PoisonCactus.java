...
public class PoisonCactus extends Block implements IPlantable
{
    ...
    public boolean canSustainPlant(IBlockAccess world, int x, int y, int z, ForgeDirection direction, IPlantable plantable)
    {
        ...
        Block planted = plantable.getPlant(world, x, y - 1, z);
        EnumPlantType plantType = plantable.getPlantType(world, x, y + 1, z);

        if (plant == DayzMod.poisonCactus && this == DayzMod.poisonCactus)
        {
            return true;
        }
        ...
        if (plantable instanceof BlockBush && planted == Blocks.sand)
        {
            return true;
        }
        ...
        switch (plantType)
        {
            case Desert: return planted == Blocks.sand;
            default: break;
        }

        return false;
    }
    protected boolean canPlaceBlockOn2(Block p_149854_1_)
    {
    ...
    public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity entity)
    {
    	...
    	{
    		((EntityLivingBase) entity).addPotionEffect(new PotionEffect(Potion.wither.id, 300 * 20, 0));
    	}
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("dayz:cactus_side");
        this.top = p_149651_1_.registerIcon("dayz:cactus_top");
        this.bottom = p_149651_1_.registerIcon("dayz:cactus_bottom");
    }
