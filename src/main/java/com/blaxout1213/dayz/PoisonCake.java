...
public class PoisonCake extends Block
{
    ...
    {
        return p_149691_1_ == 1 ? this.top : (p_149691_1_ == 0 ? this.bottom : (p_149691_2_ > 0 && p_149691_1_ == 4 ? this.inner : this.blockIcon));
    }

    @SideOnly(Side.CLIENT)
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        this.blockIcon = p_149651_1_.registerIcon("dayz:cake_side"); //side
        this.inner = p_149651_1_.registerIcon("dayz:cake_inner"); //inner
        this.top = p_149651_1_.registerIcon("dayz:cake_top"); //top
        this.bottom = p_149651_1_.registerIcon("dayz:cake_bottom"); //bottom
    }
    ...
    private void func_150036_b(World p_150036_1_, int p_150036_2_, int p_150036_3_, int p_150036_4_, EntityPlayer ep)
    {
        if (ep.canEat(false))
        {
        	ExtendedPlayer props = ExtendedPlayer.get((EntityPlayer) ep);
            ep.getFoodStats().addStats(2, 0.1F);
            //ep.addPotionEffect(new PotionEffect(Potion.wither.id, 12 * 20, 0));
